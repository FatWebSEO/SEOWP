        ...
        try {
            ...
            if (false === ($seopress_results_google_analytics_cache = get_transient('seopress_results_google_analytics'))) {
                ...
                if (seopress_get_service('GoogleAnalyticsOption')->getGA4PropertId()) {
                    ...
                    $request_by_date->setViewId($authOption);
                    ...
                    $request_users_by_language->setViewId($authOption);
                    ...
                    $request_users_by_country->setViewId($authOption);
                    ...
                    $request_users_by_device_cat->setViewId($authOption);
                    ...
                    $request_users_by_browser->setViewId($authOption);
                    ...
                    $request_users_by_social_network->setViewId($authOption);
                    ...
                    $request_users_by_channel->setViewId($authOption);
                    ...
                    $request_users_by_source->setViewId($authOption);
                    ...
                    $request_users_by_ref->setViewId($authOption);
                    ...
                    $request_page_views_page_title->setViewId($authOption);
                    ...
                    $request_events_by_cat->setViewId($authOption);
                    ...
                    $request_events_by_action->setViewId($authOption);
                    ...
                    $request_events_by_label->setViewId($authOption);
